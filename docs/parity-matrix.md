...
| Bulk list-editable update | partial | Strict row schema, duplicate-PK rejection, unchanged-row skip, and all-rows-before-write tests | Full changelist formset semantics and richer per-row errors |
