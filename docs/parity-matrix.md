...
| Docs/OpenAPI routes | partial | `/docs`, `/openapi.json`, semantic model-route contract tests, generated JSON mutation examples, generated per-model component examples, built-in site-route success examples, auth-aware built-in/model route maps, alternate custom-action success maps, and custom-route success/error response maps | Broader model-route snapshots |
