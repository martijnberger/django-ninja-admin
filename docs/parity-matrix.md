...
| Docs/OpenAPI routes | partial | `/docs`, `/openapi.json`, semantic model-route contract tests, generated JSON mutation examples, generated per-model component examples, built-in site-route success examples, auth-aware built-in/model route maps, alternate custom-action success maps, custom-route success/error response maps, and `just openapi-diff` contract-review tooling | Broader model-route snapshots |
