...
| Pagination/show all | implemented | `ChangeList`, pagination/show-all/last-page tests, row/result indexes, page-result/range metadata, structured page choices, first/previous/next/last query strings, admin-style page range metadata, and `show_full_result_count` tests | Large-result behavior |
