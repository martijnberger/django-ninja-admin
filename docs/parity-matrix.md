...
| Ordering/sort links | partial | Sort metadata plus multi-column ordering state/link tests and stale-page reset in generated links | Deeper Django query-string semantics |
