...
| Behavior | Status | Evidence | Remaining Work |
| --- | --- | --- | --- |
| Create/update/delete routes | partial | CRUD/history tests plus mounted save-form/save/delete/response hook and allowed/bad `_to_field` detail/update/delete tests | More response hook edge cases |
