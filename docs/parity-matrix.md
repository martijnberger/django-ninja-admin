...
| Inline add/change/delete | partial | Formset implementation, typed inline schemas, max/delete/duplicate/conflict/unknown-object/rollback/permission tests | Readonly, per-row errors, and deeper upstream formset edge cases |
