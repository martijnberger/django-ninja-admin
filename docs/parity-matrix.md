...
| Form descriptions | partial | Widget, custom-widget, disabled-field, Django bound-field HTML names/IDs/ARIA descriptions, rendered widget attrs, bound option/subwidget metadata, rendered grouped-choice optgroups, rendered compound-widget child inputs, normalized parent/inline fieldset layout metadata, inline formset prefixes/management forms/empty forms/row metadata, hidden-initial widgets/IDs, nullable booleans, widget templates/subwidgets, option-template/checked-state/add-id-index hints, clearable file widget metadata, `SelectDateWidget`, temporal input formats, microsecond-support flags, form media, validator names/details, effective validator-derived string/numeric bounds, error-message, `empty_value`, localization, explicit input schema overrides, initial values, structured relation/autocomplete, selected relation labels, relation target-field metadata, mount-aware autocomplete/raw-id endpoint metadata, relation `limit_choices_to`, string stripping, numeric, decimal/step, flat/grouped/typed-coerced choice metadata with typed raw values, file-path/combo-field, readonly display/callable including explicit layout names and ordering hints, model-field identity, file/image, m2m, and admin-widget metadata tests | Custom field metadata and specialized widget details |
