...
| --- | --- | --- | --- |
| `_get_foreign_key` | `django_veo_admin_api/admins/inline.py`, `django_veo_admin_api/checks.py`, `django_veo_admin_api/sites.py` | Match Django inline parent foreign-key resolution for formsets and system checks. | Compare with `django.forms.models._get_foreign_key` when upgrading Django. |
