...
mcp-package-smoke:
    UV_CACHE_DIR=.uv-cache uv run python scripts/integration_package_smoke.py mcp

all-package-smoke:
    UV_CACHE_DIR=.uv-cache uv run python scripts/integration_package_smoke.py all
