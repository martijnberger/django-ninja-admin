...
typecheck-package:
    UV_CACHE_DIR=.uv-cache uv run ty check django_ninja_admin/actions.py django_ninja_admin/apps.py django_ninja_admin/decorators.py django_ninja_admin/schemas.py django_ninja_admin/exceptions.py django_ninja_admin/constants.py django_ninja_admin/routes.py django_ninja_admin/models.py django_ninja_admin/admins/auth.py django_ninja_admin/utils
