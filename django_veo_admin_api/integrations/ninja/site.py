...
from django_veo_admin_api.core.site import (
    DEFAULT_SITE_HEADER,
    CoreAdminSite,
)
...
class NinjaAdminSite(CoreAdminSite):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(name=name, include_auth=include_auth)
    ...
    def _register_model_routes(self, router, model, model_admin):
        ...
        def changelist(
            ...
            return site.changelist_operations.list(AdminRequestContext(request), model_admin).data
