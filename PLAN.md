...
- Form descriptions now expose widget template, option-template, checked-state,
  ...
  values, labels, selected states, IDs, and attrs, rendered compound-widget
  child input names/IDs/values, `ClearableFileInput` clear-checkbox
