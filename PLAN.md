...
- Form descriptions now expose widget template, fieldset, format, and
  `MultiWidget` subwidget metadata plus Django `show_hidden_initial` hidden
  initial widget metadata for richer frontend rendering.
