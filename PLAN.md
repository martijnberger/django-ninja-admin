...
- Form descriptions now expose widget template, option-template, checked-state,
  ...
  values, labels, selected states, IDs, and attrs, `ClearableFileInput`
  clear-checkbox names/IDs/labels, inline formset prefixes, management-form
  fields, empty-form template rows, per-row form metadata, and
